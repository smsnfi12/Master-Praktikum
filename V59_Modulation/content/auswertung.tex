...
Die Amplitudenmodulation mit Trägerunterdrückung wird mit dem in Abschnitt~\ref{sec:Durchführung}beschriebenen Versuchsaufbau durchgeführt.
...
\begin{table}
    ...
    \end{tabular}
\end{table}
Daraus ergibt sich für den Modulationsgrad $m$ nach Gleichung~\ref{eq:modulationsgrad}
\begin{equation*}
    m = 0,326 \pm 0,008.
\end{equation*}
...
\end{equation*} 
Der Modulationsgrad $m$ wird über Gleichung~\ref{eq:mod_2} bestimmt:
\begin{equation*}
    m = 0,64 \pm 0,25.
\end{equation*}
