...
Die Dispersion $\delta$ ist für Röntgenstrahlung sehr klein (in Größenordnung von $10^{-6}$), weshalb der Brechungsindex $n$ für Medien auf die die Röntgenstrahlung eintrifft in der Regel kleiner als 1 ist.\\
...
\end{equation*}
genähert werden.
Für Einfallswinkel $\alpha$ deutlich größer als den kritischen Winkel $\alpha_c$ ($\alpha > 3~ \alpha_c$) ergbit sich für den Reflexionskoeffizienten die Näherung
\begin{equation*}
