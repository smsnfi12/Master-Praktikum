...
\begin{figure}[H]
    ...
    \caption{Reflexion und Transmission an den Grenzflächen eines Multischichtsystems.}
...
\begin{figure}
    ...
    \caption{Typische Kiessig-Oszillationen im Reflexionsspektrum eines Multischichtsystems.}
    \label{fig:kiessig}
\end{figure}
...
Zur Berechnung der Reflexionskoeffizienten von Multischichtsystemen wird der Parrat-Algorithmus verwendet.
Der Parrat-Algorithmus ist ein rekursives Verfahren, das die Schichtdicken, Materialdichten und Rauigkeiten berücksichtigt.
...
Daraus lässt sich die Fresnelkoeffizienten ableiten:
\begin{align*}
