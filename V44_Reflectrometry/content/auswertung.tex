...
\begin{align*}
    \alpha_{G_{th}} = \SI{0.3527}{\milli\metre}& \text{with} D_{th}= \SI{20.0}{\milli\metre}& \\
    \alpha_{G_{ex}} = \SI{0.3137}{\milli\metre}& \text{with} D_{ex}= \SI{22.49}{\milli\metre}& 
\end{align*}
...
Mit der korrigierten Reflektivität werden alle weiteren Auswertungsschritte durchgeführt. Zunächst wird die Schichtdicke des Polysterol-Films über die Gleichung~\ref{eq:d_pol} 
...
$\Delta q_z = 0.0071\pm0.0005$ kann die Schichtdicke zu $d = \SI{88.27\pm6.24}{\angstrom}$ bestimmt werden, was eine erste Abschätzung dargestellt. 
...
Wie im Unterabschnitt~\ref{sec:multi} beschrieben, können mit den Parratt-Algorithmus weitere Eigenschaften der Probe anhand der Reflektivitätsmessung bestimmt werden.
...
\begin{table}[h]
    \centering
    \caption{Parrat-Fit Parameter im Vergleich zu Theoriewerten.}
