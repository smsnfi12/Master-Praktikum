...
Das Diffraktometer ist mit einem Probentisch, einer Röntgenröhre und einem Detector ausgestattet.
...
Hierfür wird ein Omega/2Theta-Scan im Bereich von $0^\circ -2,5^\circ$ mit einer Schrittweite von $0,005^\circ$ und einer Messdauer von 5 s pro Messpunkt durchgeführt.
Zur Messung der diffusen Strahlung wird ein zusätzlicher Omega/2Theta-Scan mit einem Versatz von $2^\circ$ zum primären Scan durchgeführt.
