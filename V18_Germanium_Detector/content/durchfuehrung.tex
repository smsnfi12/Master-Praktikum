...
The 4 different isotopes are $^{152}$Eu, $^{137}$Cs, $^{133}$Ba, and one unknown source. The probes are placed in the mount one at a time, each for approximately
$\SI{90}{\minute}$.
...
background radiation is then taken overnight, with no source in the mount.
